...
public class EntityMagicMissile extends Entity
{
	private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
	...
	public EntityMagicMissile(World par1World, EntityLiving par2EntityLiving, double par3, double par5, double par7, EntityLivingBase par9)
    {
        super(par1World);
    ...
    {
        return 0.7F + (DungeonMobsHelper.getDifficulty(this.worldObj) * 0.2F);
    }
	...
	public void updateAcceleration()
	{
		...
		double targetX = this.myTarget.posX + this.myTarget.motionX;
		double targetY = this.myTarget.boundingBox.minY + this.myTarget.motionY + this.myTarget.getEyeHeight();
		double targetZ = this.myTarget.posZ + this.myTarget.motionZ;
		
		this.accelerationX = this.posX / targetX * 0.1D;
		this.accelerationY = this.posY / targetY * 0.1D;
		this.accelerationZ = this.posZ / targetZ * 0.1D;
	}
	*/
	...
	public void onUpdate()
    {
        ...
        else if(!this.isDead)
        {
            ...
            for (int var8 = 0; var8 < var5.size(); ++var8)
            {
                ...
                if (var9.canBeCollidedWith() && !var9.isEntityEqual(this.shootingEntity) && !(var9 instanceof EntityArrow) && !(var9 instanceof EntityThrowable) && !(var9 instanceof EntityEyeRay) && !(var9 instanceof EntityMagicMissile) && !(var9 instanceof EntityRakshasaImage))
                {
                    float var10 = 0.3F;
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        //par1NBTTagCompound.setInteger("entityTarget", this.myTarget.entityId);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        //this.myTarget = (EntityLiving)this.worldObj.getEntityByID(par1NBTTagCompound.getInteger("entityTarget"));
    }
